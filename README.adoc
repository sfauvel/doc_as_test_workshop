...
You can found some basic link:pages/asciidoc.{page_extension}[syntaxes examples here] or got to the link:https://docs.asciidoctor.org/asciidoc/latest/syntax-quick-reference/[syntax-quick-reference] page of the asciidoc site.
