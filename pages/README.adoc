...
image:qr_code_workshop.svg[width=400px] +
...
// Externalize configuration of the board: always the same but visible in each test
// Set board from a json or create a report of the state in json
// Write an algorithm to move the parrot
// Compute the time taken pas the parrot travel
